...
class AtomEncoder(L.LightningModule):
    ...
    def __init__(self, dim_emb):
        ...
        for i, dim in enumerate(full_atom_feature_dims):
            emb = torch.nn.Embedding(dim, dim_emb)
...
class RWSENodeEncoder(L.LightningModule):
    """
...
class NodeEncoder(L.LightningModule):
...
class BondEncoder(L.LightningModule):
...
class EdgeEncoder(L.LightningModule):
...
class FeatureEncoder(L.LightningModule):
    """
